...
#define VEC_T_NAN FLOAT32_NAN
	...
	public:
		...
		VMatrix(const CVector& forward, const CVector& left, const CVector& up, const CVector& translation);
		...
		void		GetBasisVectors(CVector& vForward, CVector& vLeft, CVector& vUp) const;
		void		SetBasisVectors(const CVector& vForward, const CVector& vLeft, const CVector& vUp);
